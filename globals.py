...
if ("df_despesas.csv" in os.listdir()) and ("df_receitas.csv" in os.listdir()):
    df_despesas = pd.read_csv("df_despesas.csv", index_col=0, parse_dates=True,date_format='YYYY-mm-DD')
    df_receitas = pd.read_csv("df_receitas.csv", index_col=0, parse_dates=True,date_format='YYYY-mm-DD')
